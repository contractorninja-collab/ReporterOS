...
| PUT             | `/api/outlet-transfers/:id`                                    | Yes  | Row visible to caller; verification is sender/executive-only while pending, with strict quantity and completion checks.                             |
| DELETE          | `/api/outlet-transfers/:id`                                    | Yes  | Executive only.                                                                                                                                       |
